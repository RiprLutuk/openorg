...
export const INDONESIA_CITY_COORDINATES: Record<string, LatLng> = {
  ...
  "kota administrasi jakarta timur": { lat: -6.225, lng: 106.9004 },
  "jakarta utara": { lat: -6.1384, lng: 106.864 },
  "kota administrasi jakarta utara": { lat: -6.1384, lng: 106.864 },
  ...
  "kota bogor": { lat: -6.5971, lng: 106.806 },
  "kabupaten bogor": { lat: -6.5518, lng: 106.852 },
  ...
  "kota cirebon": { lat: -6.732, lng: 108.5523 },
  sukabumi: { lat: -6.9277, lng: 106.93 },
  "kota sukabumi": { lat: -6.9277, lng: 106.93 },
  ...
  serang: { lat: -6.1104, lng: 106.164 },
  "kota serang": { lat: -6.1104, lng: 106.164 },
  ...
  "kota kediri": { lat: -7.848, lng: 112.0178 },
  ...
  "tapanuli utara": { lat: 2.0094, lng: 98.9774 },
  "kabupaten tapanuli utara": { lat: 2.0094, lng: 98.9774 },
  tarutung: { lat: 2.0253, lng: 98.9667 },
  "tapanuli tengah": { lat: 1.87, lng: 98.6667 },
  "kabupaten tapanuli tengah": { lat: 1.87, lng: 98.6667 },
  "tapanuli selatan": { lat: 1.5, lng: 99.25 },
  "kabupaten tapanuli selatan": { lat: 1.5, lng: 99.25 },
  toba: { lat: 2.3333, lng: 99.2167 },
  "kabupaten toba": { lat: 2.3333, lng: 99.2167 },
  simalungun: { lat: 2.9, lng: 99.0 },
  "kabupaten simalungun": { lat: 2.9, lng: 99.0 },
  "pematang siantar": { lat: 2.9583, lng: 99.0667 },
  "kota pematangsiantar": { lat: 2.9583, lng: 99.0667 },
  asahan: { lat: 2.9833, lng: 99.6167 },
  "kabupaten asahan": { lat: 2.9833, lng: 99.6167 },
  kisaran: { lat: 2.9833, lng: 99.6167 },
  "deli serdang": { lat: 3.55, lng: 98.7167 },
  "kabupaten deli serdang": { lat: 3.55, lng: 98.7167 },
  karo: { lat: 3.1167, lng: 98.5 },
  "kabupaten karo": { lat: 3.1167, lng: 98.5 },
  berastagi: { lat: 3.1833, lng: 98.5 },
  dairi: { lat: 2.75, lng: 98.3 },
  "kabupaten dairi": { lat: 2.75, lng: 98.3 },
  langkat: { lat: 3.75, lng: 98.3 },
  "kabupaten langkat": { lat: 3.75, lng: 98.3 },
  binjai: { lat: 3.6, lng: 98.4833 },
  "kota binjai": { lat: 3.6, lng: 98.4833 },
  "tebing tinggi": { lat: 3.3283, lng: 99.1625 },
  "kota tebing tinggi": { lat: 3.3283, lng: 99.1625 },
  "tanjung balai": { lat: 2.9667, lng: 99.8 },
  "kota tanjungbalai": { lat: 2.9667, lng: 99.8 },
  sibolga: { lat: 1.7428, lng: 98.7792 },
  "kota sibolga": { lat: 1.7428, lng: 98.7792 },
  "padang sidempuan": { lat: 1.3733, lng: 99.2683 },
  "kota padangsidimpuan": { lat: 1.3733, lng: 99.2683 },
  gunungsitoli: { lat: 1.2833, lng: 97.6167 },
  "kota gunungsitoli": { lat: 1.2833, lng: 97.6167 },
  nias: { lat: 1.15, lng: 97.6 },
  "kabupaten nias": { lat: 1.15, lng: 97.6 },
  labuhanbatu: { lat: 2.15, lng: 99.9833 },
  "kabupaten labuhanbatu": { lat: 2.15, lng: 99.9833 },
  "mandailing natal": { lat: 0.85, lng: 99.55 },
  "kabupaten mandailing natal": { lat: 0.85, lng: 99.55 },
  "serdang bedagai": { lat: 3.45, lng: 99.05 },
  "kabupaten serdang bedagai": { lat: 3.45, lng: 99.05 },
  "humbang hasundutan": { lat: 2.25, lng: 98.75 },
  "kabupaten humbang hasundutan": { lat: 2.25, lng: 98.75 },
  "pakpak bharat": { lat: 2.55, lng: 98.25 },
  "kabupaten pakpak bharat": { lat: 2.55, lng: 98.25 },
  samosir: { lat: 2.6, lng: 98.7 },
  "kabupaten samosir": { lat: 2.6, lng: 98.7 },
  "batu bara": { lat: 3.15, lng: 99.55 },
  "kabupaten batu bara": { lat: 3.15, lng: 99.55 },
  ...
  "pangkal pinang": { lat: -2.129, lng: 106.1139 },
  ...
  banjarmasin: { lat: -3.3167, lng: 114.59 },
  "kota banjarmasin": { lat: -3.3167, lng: 114.59 },
  banjarbaru: { lat: -3.44, lng: 114.83 },
  ...
  palu: { lat: -0.9, lng: 119.8333 },
  "kota palu": { lat: -0.9, lng: 119.8333 },
...
export const PROVINCE_FALLBACK_COORDINATES: Record<string, LatLng> = {
  ...
  "papua pegunungan": { lat: -4.09, lng: 138.94 },
};
...
export function extractCoordinatesFromMapsUrl(
  ...
  const matchQuery = url.match(
    /[?&](?:q|ll|query|saddr|daddr)=(-?\d+\.\d+),(-?\d+\.\d+)/,
  );
