...
export const INDONESIA_CITY_COORDINATES: Record<string, LatLng> = {
  ...
  "tapanuli tengah": { lat: 1.8700, lng: 98.6667 },
  "kabupaten tapanuli tengah": { lat: 1.8700, lng: 98.6667 },
  "tapanuli selatan": { lat: 1.5000, lng: 99.2500 },
  "kabupaten tapanuli selatan": { lat: 1.5000, lng: 99.2500 },
  "toba": { lat: 2.3333, lng: 99.2167 },
  "kabupaten toba": { lat: 2.3333, lng: 99.2167 },
  "simalungun": { lat: 2.9000, lng: 99.0000 },
  "kabupaten simalungun": { lat: 2.9000, lng: 99.0000 },
  ...
  "deli serdang": { lat: 3.5500, lng: 98.7167 },
  "kabupaten deli serdang": { lat: 3.5500, lng: 98.7167 },
  "karo": { lat: 3.1167, lng: 98.5000 },
  "kabupaten karo": { lat: 3.1167, lng: 98.5000 },
  "berastagi": { lat: 3.1833, lng: 98.5000 },
  "dairi": { lat: 2.7500, lng: 98.3000 },
  "kabupaten dairi": { lat: 2.7500, lng: 98.3000 },
  "langkat": { lat: 3.7500, lng: 98.3000 },
  "kabupaten langkat": { lat: 3.7500, lng: 98.3000 },
  ...
  "tanjung balai": { lat: 2.9667, lng: 99.8000 },
  "kota tanjungbalai": { lat: 2.9667, lng: 99.8000 },
  ...
  "nias": { lat: 1.1500, lng: 97.6000 },
  "kabupaten nias": { lat: 1.1500, lng: 97.6000 },
  "labuhanbatu": { lat: 2.1500, lng: 99.9833 },
  "kabupaten labuhanbatu": { lat: 2.1500, lng: 99.9833 },
  "mandailing natal": { lat: 0.8500, lng: 99.5500 },
  "kabupaten mandailing natal": { lat: 0.8500, lng: 99.5500 },
  "serdang bedagai": { lat: 3.4500, lng: 99.0500 },
  "kabupaten serdang bedagai": { lat: 3.4500, lng: 99.0500 },
  "humbang hasundutan": { lat: 2.2500, lng: 98.7500 },
  "kabupaten humbang hasundutan": { lat: 2.2500, lng: 98.7500 },
  "pakpak bharat": { lat: 2.5500, lng: 98.2500 },
  "kabupaten pakpak bharat": { lat: 2.5500, lng: 98.2500 },
  "samosir": { lat: 2.6000, lng: 98.7000 },
  "kabupaten samosir": { lat: 2.6000, lng: 98.7000 },
  "batu bara": { lat: 3.1500, lng: 99.5500 },
  "kabupaten batu bara": { lat: 3.1500, lng: 99.5500 },
