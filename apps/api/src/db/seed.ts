...
<p>APTI mewajibkan penggunaan pipa tembaga berkode ASTM B280 dengan ketebalan minimal 0.61mm (grade H atau setara) demi menjamin keamanan dan masa pakai unit di atas 10 tahun.</p>`,
    ...
    // 7. Pengaduan Masyarakat & Kode Etik Desk (JENDELA)
    await tx.insert(publicComplaints).values([
      {
        ...
        description:
          "Pengerjaan servis cuci AC dan isi freon di area Kelapa Gading Jakarta Utara pada tanggal 12 Februari 2026. Unit kembali tidak dingin dalam 4 hari, namun teknisi tidak merespon saat dihubungi untuk klaim garansi servis 30 hari.",
        status: "under_review",
        responseNotes:
          "Sekretariat DPD DKI Jakarta telah menghubungi pihak teknisi bersangkutan untuk menjadwalkan kunjungan verifikasi dan pengerjaan ulang garansi.",
      },
      {
        ...
        targetType: "workshop",
        targetIdentifier: "Bandung Cold Solution (TKT-DPD-JBR-002)",
        category: "Kecurangan Takaran Freon & Biaya",
        description:
          "Laporan ketidaksesuaian penagihan biaya pengisian refrigeran R32 sebanyak 3 unit kantor di Dago Bandung. Jumlah penagihan tidak sesuai dengan pembacaan manifold pressure yang tercatat pada nota.",
        status: "mediated",
        responseNotes:
          "Tim Etik DPD Jawa Barat telah melakukan mediasi bersama pemilik workshop dan konsumen. Pihak workshop telah mengembalikan selisih biaya dan menerbitkan nota revisi.",
      },
      {
        ticketNumber: "CMP-2026-0105",
        complainantName: "Hendra Gunawan",
        complainantEmail: "hendra.gunawan@permatacool.co.id",
        complainantPhone: "081388776655",
        targetType: "technician",
        targetIdentifier: "Agus Pratama (APTI-2026-0005)",
        category: "Dugaan Malpraktik & Kerusakan Unit",
        description:
          "Dugaan pipa tembakau patah saat pembongkaran outdoor AC Cassette 4 PK di ruko Grogol. Memerlukan peninjauan teknis Dewan Etik terkait penggantian sparepart.",
        status: "new",
        responseNotes: null,
      },
      {
        ticketNumber: "CMP-2026-0118",
        complainantName: "Maya Indah Puspita",
        complainantEmail: "maya.indah@gmail.com",
        complainantPhone: "081900112233",
        targetType: "partner",
        targetIdentifier: "PT Prima Alat Refrigerasi",
        category: "Klaim Garansi Servis & Pengerjaan Ulang",
        description:
          "Pengajuan garansi pompa vakum 2-stage yang rusak saat pemakaian 2 minggu pertama. Distributor lambat memproses penggantian unit baru.",
        status: "resolved",
        responseNotes:
          "Distributor telah mengirimkan unit pompa vakum pengganti baru beserta kalibrasi resmi dari prinsipal. Berita acara serah terima telah ditandatangani.",
      },
      {
        ticketNumber: "CMP-2026-0129",
        complainantName: "Dr. Irwan Siregar",
        complainantEmail: "irwan.siregar@medanclinic.com",
        complainantPhone: "081122334455",
        targetType: "technician",
        targetIdentifier: "Teknisi Mandiri Medan",
        category: "Pelanggaran Kode Etik & Perilaku",
        description:
          "Teknisi mengenakan seragam APTI palsu dan tidak memiliki nomor KTA aktif saat menawarkan jasa servis ruang operasi klinik.",
        status: "dismissed",
        responseNotes:
          "Setelah verifikasi database KTA nasional, oknum bukan merupakan anggota APTI resmi. Kasus telah diteruskan kepada pihak berwenang untuk penertiban atribut organisasi.",
      },
    ]);
    ...
    await tx.insert(championshipStandings).values([
      ...
      },
      {
        ...
        rank: 7,
        achievements:
          "Juara 7 Kalibrasi Thermostat Smart Inverter & Sensor Suhu",
      },
      {
        seasonYear: 2026,
        category:
        ...
        rank: 8,
        achievements:
          "Juara 8 Flaring & Swaging Pipa Tembaga Presisi Tanpa Retak",
      },
      {
        seasonYear: 2026,
        category:
        ...
        rank: 9,
        achievements:
          "Juara 9 Pengelasan Perak 45% Pipa Suction Chiller Industri",
      },
      {
        seasonYear: 2026,
        category:
    ...
    await tx.insert(workingGroups).values([
      ...
      {
        name: "Pokja Vokasi, Magang & Kerjasama SMK/Politeknik",
        slug: "pokja-vokasi-pendidikan",
        chairName: "Bambang Sugeng, M.Pd.",
        category: "Pendidikan & Vokasi",
        description:
          "Menyusun kurikulum sinkronisasi industri pendingin dengan SMK Teknik Pendingin Tata Udara (TPTU) dan Politeknik Negeri se-Indonesia.",
        memberCount: 22,
        isActive: true,
      },
      {
        name: "Pokja Transisi Hijau & Efisiensi Energi (R290 & Inverter)",
        slug: "pokja-green-hvac",
        chairName: "Ir. Anisa Larasati, M.Sc.",
        category: "Teknologi Hijau & Energi",
        description:
          "Mengembangkan panduan retrofit refrigeran hidrokarbon R290, audit efisiensi energi gedung komersial, dan kalkulator COP beban pendinginan.",
        memberCount: 19,
        isActive: true,
      },
      {
        name: "Pokja Digitalisasi KTA & Bursa Bengkel Mandiri",
        slug: "pokja-digital-platform",
        chairName: "Bayu Wicaksono, S.Kom.",
        category: "Teknologi Informasi",
        description:
          "Mengelola sistem portal registri KTA digital, verifikasi QR Code keaslian kartu, serta direktori pencarian teknisi berlisensi.",
        memberCount: 14,
        isActive: true,
      },
    ]);
    ...
    await tx.insert(technicianDirectories).values([
      ...
      {
        name: "Rian Hidayat",
        ktaNumber: "APTI-2026-0007",
        skillLevel: "Level 4 Komersial & Inverter VRV",
        province: "Jawa Timur",
        city: "Surabaya",
        phone: "081233445566",
        workshopName: "Surabaya Mandiri Cool",
        rating: "4.91",
        certifiedBnsp: true,
        isAvailable: true,
      },
      {
        name: "Fajar Nugroho",
        ktaNumber: "APTI-2026-0008",
        skillLevel: "Level 3 Residensial & Split",
        province: "DI Yogyakarta",
        city: "Sleman",
        phone: "081377889900",
        workshopName: "Jogja Istimewa Aircon",
        rating: "4.87",
        certifiedBnsp: true,
        isAvailable: true,
      },
      {
        ...
        ktaNumber: "APTI-2026-0009",
        skillLevel: "Level 4 Komersial & Inverter VRV",
        province: "Banten",
        city: "Tangerang Selatan",
        phone: "081899001122",
        workshopName: "BSD Serpong Cooling Engineering",
        rating: "4.94",
        certifiedBnsp: true,
        isAvailable: true,
      },
      {
        ...
        ktaNumber: "APTI-2026-0010",
        skillLevel: "Level 4 Chiller & Cold Storage",
        province: "Bali",
        city: "Denpasar",
        phone: "081244556677",
        workshopName: "Bali Tropical HVAC Solutions",
        rating: "4.96",
        certifiedBnsp: true,
        isAvailable: true,
      },
      {
        name: "Hendra Saputra",
        ktaNumber: "APTI-2026-0011",
        skillLevel: "Level 3 Residensial & Split",
        province: "Sumatera Utara",
        city: "Medan",
        phone: "081355667788",
        workshopName: "Medan Prima Refrigerasi",
        rating: "4.85",
        certifiedBnsp: true,
        isAvailable: true,
      },
      {
        name: "Andi Wijaya",
        ktaNumber: "APTI-2026-0012",
        skillLevel: "Level 4 Komersial & Inverter VRV",
        province: "Sulawesi Selatan",
        city: "Makassar",
        phone: "081266778899",
        workshopName: "Makassar Sentosa Cool",
        rating: "4.89",
        certifiedBnsp: true,
        isAvailable: true,
      },
      {
        name: "Rizky Ramadhan",
        ktaNumber: "APTI-2026-0013",
        skillLevel: "Level 2 Teknisi Perawatan Dasar",
        province: "Riau",
        city: "Pekanbaru",
        phone: "081377665544",
        workshopName: "Pekanbaru Mitra Mandiri AC",
        rating: "4.78",
        certifiedBnsp: false,
        isAvailable: true,
      },
      {
        name: "Eko Prasetyo",
        ktaNumber: "APTI-2026-0014",
        skillLevel: "Level 4 Chiller & Cold Storage",
        province: "Kalimantan Timur",
        city: "Balikpapan",
        phone: "081288990011",
        workshopName: "Balikpapan Cold Chain Service",
        rating: "4.90",
        certifiedBnsp: true,
        isAvailable: true,
      },
      {
        name: "Dedi Hermanto",
        ktaNumber: "APTI-2026-0015",
        skillLevel: "Level 3 Residensial & Split",
        province: "Sumatera Selatan",
        city: "Palembang",
        phone: "081399887711",
        workshopName: "Sriwijaya Aircon Sentra",
        rating: "4.82",
        certifiedBnsp: true,
        isAvailable: true,
      },
      {
        name: "Anton Setiawan",
        ktaNumber: "APTI-2026-0016",
        skillLevel: "Level 2 Teknisi Perawatan Dasar",
        province: "Lampung",
        city: "Bandar Lampung",
        phone: "081277665533",
        workshopName: "Lampung Jaya Servis AC",
        rating: "4.76",
        certifiedBnsp: false,
        isAvailable: true,
      },
      {
        name: "Ilham Maulana",
        ktaNumber: "APTI-2026-0017",
        skillLevel: "Level 3 Residensial & Split",
        province: "Nusa Tenggara Barat",
        city: "Mataram",
        phone: "081866554433",
        workshopName: "Lombok Fresh Cooling",
        rating: "4.84",
        certifiedBnsp: true,
        isAvailable: true,
      },
      {
        name: "Surya Darmawan",
        ktaNumber: "APTI-2026-0018",
        skillLevel: "Level 3 Residensial & Split",
        province: "Kalimantan Barat",
        city: "Pontianak",
        phone: "081255443322",
        workshopName: "Khatulistiwa HVAC Care",
        rating: "4.80",
        certifiedBnsp: true,
        isAvailable: true,
      },
      {
        ...
        ktaNumber: "APTI-2026-0019",
        skillLevel: "Level 4 Komersial & Inverter VRV",
        province: "Aceh",
        city: "Banda Aceh",
        phone: "081344332211",
        workshopName: "Serambi Aircon Specialist",
        rating: "4.88",
        certifiedBnsp: true,
        isAvailable: true,
      },
      {
        ...
        ktaNumber: "APTI-2026-0020",
        skillLevel: "Level 4 Komersial & Inverter VRV",
        province: "DKI Jakarta",
        city: "Jakarta Barat",
        phone: "081211223388",
        workshopName: "Mitra Sejuk Kebon Jeruk",
        rating: "4.93",
        certifiedBnsp: true,
        isAvailable: true,
      },
      {
        name: "Yudi Purnomo",
        ktaNumber: "APTI-2026-0021",
        skillLevel: "Level 3 Residensial & Split",
        province: "Jawa Barat",
        city: "Bekasi",
        phone: "081299334455",
        workshopName: "Bekasi Technic Aircon",
        rating: "4.86",
        certifiedBnsp: true,
        isAvailable: true,
      },
      {
        name: "Tri Wahyudi",
        ktaNumber: "APTI-2026-0022",
        skillLevel: "Level 4 Chiller & Cold Storage",
        province: "Jawa Timur",
        city: "Malang",
        phone: "081377221100",
        workshopName: "Malang Highland Cold Tech",
        rating: "4.91",
        certifiedBnsp: true,
        isAvailable: true,
      },
      {
        name: "Wahyu Hidayat",
        ktaNumber: "APTI-2026-0023",
        skillLevel: "Level 3 Residensial & Split",
        province: "DKI Jakarta",
        city: "Jakarta Timur",
        phone: "081255889922",
        workshopName: "Rawamangun Cooling Center",
        rating: "4.89",
        certifiedBnsp: true,
        isAvailable: true,
      },
    ...
    await tx.insert(registeredClubs).values([
      ...
      {
        clubName: "Surabaya Chiller & Aircon Community",
        codeTkt: "TKT-DPD-JTM-003",
        province: "Jawa Timur",
        category: "Komunitas Teknisi & Workshop",
        chairName: "Rian Hidayat",
        activeMembers: 115,
        status: "verified",
      },
      {
        clubName: "Semarang Cold Chain & HVAC Association",
        codeTkt: "TKT-DPD-JTG-004",
        province: "Jawa Tengah",
        category: "Komunitas Teknisi & Workshop",
        chairName: "Dewi Lestari",
        activeMembers: 84,
        status: "verified",
      },
      {
        clubName: "Medan Refrigeration & AC Master Club",
        codeTkt: "TKT-DPD-SMU-005",
        province: "Sumatera Utara",
        category: "Komunitas Teknisi & Workshop",
        chairName: "Hendra Saputra",
        activeMembers: 76,
        status: "verified",
      },
      {
        clubName: "Bali Island Hospitality Cooling Guild",
        codeTkt: "TKT-DPD-BAL-006",
        province: "Bali",
        category: "Komunitas Teknisi & Workshop",
        chairName: "I Wayan Sudarma",
        activeMembers: 68,
        status: "verified",
      },
      {
        clubName: "Makassar Celebes HVAC Society",
        codeTkt: "TKT-DPD-SLS-007",
        province: "Sulawesi Selatan",
        category: "Komunitas Teknisi & Workshop",
        chairName: "Andi Wijaya",
        activeMembers: 59,
        status: "verified",
      },
      {
        clubName: "Tangerang Raya Industrial AC Engineers",
        codeTkt: "TKT-DPD-BTN-008",
        province: "Banten",
        category: "Komunitas Teknisi & Workshop",
        chairName: "Muhammad Farhan",
        activeMembers: 92,
        status: "verified",
      },
    ]);
    ...
    await tx.insert(lenderRegistries).values([
      ...
      {
        brandName: "Gree Electric Appliances Indonesia",
      ...
      {
        brandName: "Copeland & Emerson Climate",
        companyName: "PT Emerson Commercial & Residential Solutions",
        licenseNumber: "SK-DIST-DPP-006",
        sectorType: "Kompresor Scroll & Semi-Hermetic",
        ojkStatus: "Distributor Terakreditasi",
        websiteUrl: "https://copeland.com",
        isAfpiMember: true,
      },
      {
        brandName: "Bitzer Compressor Indonesia",
        companyName: "PT Bitzer Compressors Indonesia",
        licenseNumber: "SK-DIST-DPP-007",
        sectorType: "Kompresor Industri Cold Storage",
        ojkStatus: "Distributor Terakreditasi",
